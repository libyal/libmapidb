...
$LibraryTests = "database error folder support"
...
Function RunTest
{
	...
	$TestExecutable = "${TestExecutablesDirectory}\mapidb_test_${TestName}.exe"
...
Function RunTestWithInput
{
	...
	$TestProfileDirectory = GetTestProfileDirectory "input" "libmapidb"
